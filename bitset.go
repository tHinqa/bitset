...
var popcount_2 func(uint64) uint64 = hamming_popcount_2

func init(){
	// popcount_2 = hamming_popcount_2 // default
	// popcount_2 = gcc_popcount_2
	// popcount_2 = naive_popcount_2
	// popcount_2 = asmnaive_popcount_2
	// popcount_2 = asmhamming_popcount_2
	if cpuHasPopcnt() {
		popcount_2 = intrinsic_popcount_2
	} else {
		popcount_2 = hamming_popcount_2
	}
}
